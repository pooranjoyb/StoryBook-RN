...
import { View, Linking, Text, Pressable, StyleSheet, TextInput,Animated} from 'react-native';
...
const Home = () => {
    ...
    const splitWords = (text) => {
        return text.split(' ').map((word, index) => (
            <Animated.Text key={index} style={[styles.animatedText, { opacity: fadeInText }]}>
                {word}{' '}
            </Animated.Text>
        ));
